  ...
  askPluginSpecs: () => {
    ...
    const questions = [
      ...
      },
      {
        name: 'plugin_uri',
        type: 'confirm',
        message: `Will the plugin reside in the following repository: https://github.com/IIP-Design/${dir}?`,
        default: true
      },
      {
      ...
      },
      {
        ...
        type: 'confirm',
        message: `Would you like to use "iip-${dir}" as the plugin's text domain?`
      },
      {
        when: function( response ) {
